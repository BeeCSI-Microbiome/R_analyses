...
Maaslin2_DA = use("scripts/Maaslin2_DA.R")
# _________________________________________________________________________
...
mas_dir = glue("{main_outdir}/MaAsLin2_differential_abundance")
...
ifelse(!dir.exists(mas_dir), dir.create((mas_dir), mode = "777"), FALSE)



## Input file paths ####
# Counts (clade and taxon counts, uncollapsed) and metadata tables (mas metadata file is the exact same as the other metadata, just in tsv format)
counts_path <- "C:/Users/obrienj/OneDrive - AGR-AGR/Desktop/Bee Stuff/tsv/cas_all_taxa.tsv"
metadata_filepath <- "C:/Users/obrienj/OneDrive - AGR-AGR/Desktop/Bee Stuff/R_analyses/cas_2020_metadata.csv"
mas_metadata_filepath = "C:/Users/obrienj/OneDrive - AGR-AGR/Desktop/Bee Stuff/R_analyses/cas_2020_metadata.txt"

# Path to directory with kraken reports
kraken_report_dir <- "C:/Users/obrienj/OneDrive - AGR-AGR/Desktop/Bee Stuff/Kraken Data"
...
da$kraken_differential_abundance(kraken_matrix_dir,
                                 ...
                                 css_percentile)
Maaslin2_DA$MaAsLin2_DA_function(kraken_matrix_dir, 
                                 mas_metadata_filepath,
                                 mas_dir)
