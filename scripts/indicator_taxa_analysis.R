# Identifying "indicator taxa" - taxa found more often in one treatment group
# compared to another. This is considered another differential abundance method.
#
# Using: https://jkzorz.github.io/2019/07/02/Indicator-species-analysis.html
...
run_indicator_analysis <- function(table,
                                   treatment_key,
                                   dataset_name,
                                   output_dir,
                                   rank_symbol = "all") {
  ...
  # drop timepoint column if regex didn't find timepoints
  ...
  # adjusted p-vals
  # extract table of stats for treatment
