...
main_outdir <- glue("{path}/results/act2_results/{dataset_name}")
...
kableExtra::kbl(c(glue("{dataset_name}_Genus_ancombc.csv"),
               glue("{dataset_name}_Species_ancombc.csv"),
...
genusANCOM <- read.csv(glue("{da_ancombc_dir}/{dataset_name}_Genera_ancombc.csv"))
...
```{r, echo = FALSE}
kableExtra::kbl(c(glue("{dataset_name}_treatment_indicators_Genus.txt"),
  glue("{dataset_name}_treatment_indicators_Species.txt"),
  glue("{dataset_name}_replicate_indicators_Genus.txt"),
  glue("{dataset_name}_replicate_indicators_Species.txt")),
  col.names = "File names", booktabs = TRUE) %>%
  kableExtra::kable_styling(latex_options = c("striped", "hold_position"))
```
...
**Base file location:**
  ...
  * `r trim_path(ind_sp_dir)`
```{r, echo = FALSE}
kableExtra::kbl(c(glue("{dataset_name}_treatment_indicators_Genus.csv"),
  glue("{dataset_name}_treatment_indicators_Species.csv"),
  glue("{dataset_name}_replicate_indicators_Genus.csv"),
  glue("{dataset_name}_replicate_indicators_Species.csv")),
  col.names = "File names", booktabs = TRUE) %>%
  kableExtra::kable_styling(latex_options = c("striped", "hold_position"))
```
